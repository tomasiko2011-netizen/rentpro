  ...
  useEffect(() => {
    fetch(`/api/properties/${id}`)
      ...
      .then((data) => {
        ...
        try { amenities = JSON.parse(data.amenities || "[]"); } catch {}
        let parsedPhotos: string[] = [];
        try { parsedPhotos = JSON.parse(data.photos || "[]"); } catch {}
        ...
        setForm({
          ...
          priceWeekday: data.priceWeekday || 10000,
          priceWeekend: data.priceWeekend || 15000,
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Редактировать объект</h1>
      </div>

      <form onSubmit={handleSubmit}>
        <Card className="mb-4">
          <CardHeader><CardTitle className="text-lg">Основное</CardTitle></CardHeader>
        ...
        <Card className="mb-4">
          <CardHeader><CardTitle className="text-lg">Параметры</CardTitle></CardHeader>
          <CardContent>
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <Input type="number" min={1} value={form.beds} onChange={(e) => setForm({ ...form, beds: Number(e.target.value) })} />
              </div>
              <div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div>
                ...
                <Input type="number" value={form.priceWeekday} onChange={(e) => setForm({ ...form, priceWeekday: Number(e.target.value) })} />
              </div>
              <div>
                <Label>Цена выходные (₸)</Label>
                <Input type="number" value={form.priceWeekend} onChange={(e) => setForm({ ...form, priceWeekend: Number(e.target.value) })} />
              </div>
            </div>
            <div className="grid grid-cols-3 gap-3">
              <div>
        ...
        <Card className="mb-6">
          <CardHeader><CardTitle className="text-lg">Фото</CardTitle></CardHeader>
          <CardContent>
